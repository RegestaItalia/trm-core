...
export interface ISystemConnector extends ISystemConnectorBase {
    ...
    importTransport: (trkorr: components.TRKORR, system: components.TMSSYSNAM, test: boolean) => Promise<struct.STMS_TP_IMPORT>,
    importTransportMultiple: (trkorr: components.TRKORR[], system: components.TMSSYSNAM, test: boolean) => Promise<struct.STMS_TP_IMPORT>,
