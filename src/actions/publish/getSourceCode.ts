...
export const getSourceCode: Step<PublishWorkflowContext> = {
    ...
    run: async (context: PublishWorkflowContext): Promise<void> => {
        ...
        try{
            ...
            Logger.info(`AbapGit Developer Edition was not found, skipping source code and git ignore extraction.`, true); //logged as debug but in future releases (maybe when source code migh actually be needed) format this message better
        }
    }
}