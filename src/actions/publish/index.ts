 ...
 * or registry publication fails. A final local package-record update failure is logged without
 * rejecting because the registry publication has already succeeded.
 */
